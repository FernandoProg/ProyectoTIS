<?php
    ...
    $sql = "INSERT INTO noticia (nombre_admin, titulo_noticia, fecha_noticia, bajada_noticia, lead_noticia, cuerpo_noticia, categoria_noticia, imagen_noticia) VALUES ('$nombre_admin','$titulo_noticia','$fecha_noticia','$bajada_noticia','$lead_noticia','$cuerpo_noticia','$categoria_noticia','$imagen_noticia')";
