        ...
        <div class="row">
            <div class="col-lg-12"> 
              ...
              <form action="Consultas/insert_noticia.php" enctype="multipart/form-data" method="POST">
                ...
                <div class="mb-3">
                  ...
                  <input type="text" class="form-control shadow-sm" name="insert_titulo_noticia" maxlength="100" placeholder="Elecciones presidenciales 2021" required>
                </div>
                <div class="mb-3">
                  <label class="form-label fw-bolder" >Bajada:</label>
                  <!--<input type="text" class="form-control" name="insert_bajada_noticia">-->
                  <textarea name="insert_bajada_noticia" class="form-control shadow-sm" cols="30" rows="2" maxlength="200" 
                ...
                <div class="mb-3">
                  ...
                  <textarea name="insert_lead_noticia" class="form-control shadow-sm" cols="30" rows="5" maxlength="400" 
                ...
                <div class="mb-3">
                  ...
                  <textarea name="insert_cuerpo_noticia" class="form-control shadow-sm" cols="30" rows="10" maxlength="10000" 
                ...
                <div class="mb-3 col-sm-12 col-md-4">
                  ...
                  <input type="file" accept="image/png, .jpeg, .jpg .svg .jpg" class="form-control shadow-sm" name="insert_imagen_noticia" required>
                </div>
            ...
            <div class="col-lg-12 mt-5">
              ...
              <div class="table-responsive ">
                <table class="table shadow-sm table-striped table-hover table-bordered table-light" id="myTable">
