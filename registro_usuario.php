            ...
            <form class="form mt-5">
              <div class="mb-3 row">
                <div class="col-lg-6 col-sm-12 col-md-12">
                  ...
                  <input type="text" disabled class="form-control" id="exampleInputEmail1" placeholder="JuanPerez1 , felipeBurgos14 , JuanFarias , etc..." name="nombreUsuario" maxlength="50">
                ...
                <div class="col-lg-6 col-sm-12 col-md-12">
                  ...
                  <input type="email" disabled class="form-control" id="exampleInputEmail1" placeholder="name@xample.com" name="correoUsuario" maxlength="50">
                  <div id="emailHelp" class="form-text"></div>
                </div>
              </div>
              <div class="mb-3 col-lg-4 col-sm-12 ">
                <label for="exampleInputPassword1" class="fw-bolder form-label">Contraseña</label>
                <input type="password" disabled class="form-control" id="exampleInputPassword1" name="contraseña" minlength="6" maxlength="16" placeholder="28dejulio , trececatorce , etc...">
              </div>
              <a href="acceso_usuarios.php" class="btn btn-secondary">Volver atrás</a>
            </form>
          </div>
        </div>
      </div>
